...
public class XtendXpandNatureUtil {
    ...
    public final static boolean addExtXptNature(final IJavaProject jp) {
        try {
    ...
    public final static boolean removeExtXptNature(final IJavaProject jp) {
        try {
            final IProjectDescription description = jp.getProject().getDescription();
            final String[] natures = description.getNatureIds();
            for (int i = 0; i < natures.length; ++i) {
                if (XtendXpandNature.NATURE_ID.equals(natures[i])) {
                    // Remove the nature
                    ...
                    try {
                        new WorkspaceModifyOperation() {
                            ...
                            protected void execute(final IProgressMonitor monitor) throws CoreException,
                                ...
                                XtendXpandMarkerManager.deleteMarkers(jp.getProject());
