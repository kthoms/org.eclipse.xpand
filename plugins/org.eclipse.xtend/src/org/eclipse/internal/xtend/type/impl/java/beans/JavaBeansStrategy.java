...
public class JavaBeansStrategy implements JavaTypeStrategy {
	...
	/**
	 * Tests if this method is a getter for boolean property (beginning with
	 * 'is') whose return type is of the wrapper type 'java.lang.Boolean'.
	 * JavaBeans won't recognize this as an accessor method for a property.
	 * 
	 * @param method
	 *            The method to check
	 * @return <code>true</code>: the method begins with 'is', the return
	 *         type is 'java.lang.Boolean' and the method has no arguments.
	 */
	...
	/**
	 * Adds a JavaPropertyImpl to the list of features for properties of type
	 * 'java.lang.Boolean', which has a getter method beginning with 'is'.
	 * <p>
	 * If this non-standard property has a setter method than it was already
	 * added as a JavaProperty. But this instance is immutable, so the original
	 * has to be removed and another one be added.
	 * 
	 * @param typeFinder
	 ...
	 */
	private void handleNonStandardBooleanProperty(final TypeFinder typeFinder, final Type t, final List<FeatureImpl> result, final PropertyDescriptor[] pdArr,
			final Method method) {
