 ...
 */
public class XtendOpenAction extends OpenAction {

	private final XtendEditor editor;
	 ...
	 */
	public XtendOpenAction(XtendEditor editor) {
		super(editor);
		this.editor = editor;
	}
	...
	public void run(ITextSelection selection) {
		...
		XtendHyperlinkDetector detector = new XtendHyperlinkDetector(editor);
