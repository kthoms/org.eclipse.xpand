...
public class TextSelectingProposal implements ICompletionProposal {
	 ...
	 *            replacementOffset
	 */
	public TextSelectingProposal(final String replacementString, final int replacementOffset, final int replacementLength, final int cursorPosition,
	 ...
	 */
	public TextSelectingProposal(final String replacementString, final int replacementOffset, final int replacementLength, final int cursorPosition,
			final int selectionLength, final Image image, final String displayString, final IContextInformation contextInformation,
	...
	// private final static Pattern pattern = Pattern.compile("\\A\\s*" +
	// XpandTokens.RT);
	...
	public void apply(final IDocument document) {
		try {
			...
			// String s = document.get().substring(fReplacementOffset +
			// fReplacementLength);
			// Matcher m = pattern.matcher(s);
			// if (m.find()) {
			// document.replace(m.start(), m.end(), "");
			// }
