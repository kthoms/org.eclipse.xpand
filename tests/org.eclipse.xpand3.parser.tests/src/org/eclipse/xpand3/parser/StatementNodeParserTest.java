...
public class StatementNodeParserTest extends AbstractXpand3NodeParserTest {
	...
	public final void testMoreComplexDefine() throws Exception {
		...
		CompositeNode fc = checkChildIsRule(ae, 0, "featureCall", 1);
		checkChildIsSimpleType(fc, 0, "name");
		...
		CompositeNode fc1 = checkChildIsRule(es, 0, "featureCall", 1);
		checkChildIsSimpleType(fc1, 0, "name");
		checkChildIsText(s0, 2, "");
		CompositeNode fes = checkChildIsRule(s0, 3, "foreachStatement", 6);
		checkChildIsToken(fes, 0, "FOREACH");
		CompositeNode fc2 = checkChildIsRule(fes, 1, "featureCall", 1);
		checkChildIsSimpleType(fc2, 0, "eAllAttributes");
		...
		CompositeNode fc3 = checkChildIsRule(ie, 0, "featureCall", 1);
		checkChildIsSimpleType(fc3, 0, "attr");
		checkChildIsToken(ie, 1, ".");
		CompositeNode fc4 = checkChildIsRule(ie, 2, "featureCall", 1);
		checkChildIsSimpleType(fc4, 0, "name");
	...
	public final void testImportDeclaration() throws Exception {
		...
		CompositeNode i0 = checkChildIsRule(expr, 0, "import", 4);
		...
		CompositeNode i1 = checkChildIsRule(expr, 1, "import", 4);
